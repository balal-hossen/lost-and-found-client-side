            ...
            <div className="dropdown">
              ...
              <ul
                ...
                className={`menu menu-sm dropdown-content mt-3 z-[1] p-2 rounded-box w-52
                  ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-black'} shadow-md`}
              >
                {Links}

                <button
                  onClick={toggleTheme}
                  className="p-2 rounded-full bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors mt-2 w-full"
        ...
        {user && (
          <>
            ...
            <div className="space-y-3.5">
              <Link to='/addlost'>
                <button className='btn w-full' onClick={() => speakText('Add Lost and Found Item')}>
                  Add Lost & Found Item
                </button>
              </Link>
              <Link to='/allrecoverd'>
                <button className='btn w-full mt-2' onClick={() => speakText('All Recovered Items')}>
                  All Recovered Items
                </button>
              </Link>
              <Link to='/manage'>
                <button className='btn w-full mt-2' onClick={() => speakText('Manage My Items')}>
                  Manage My Items
                </button>
              </Link>
            </div>
